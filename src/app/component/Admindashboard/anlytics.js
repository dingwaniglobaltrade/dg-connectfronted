...
const anlytics = () => {
  return (
    ...
    <div className="w-full px-4 lg:h-[320px] md:h-[320px] h-full flex flex-wrap lg:gap-5 sm:gap-3 items-center justify-center">
      <DashboardHalf link={"/dbh"} lable={"Sales Analytics"} />
      <DashboardHalf link={"/portalpages/allproduct"} lable={"Top Selling Products"}  />
      <DashboardHalf  link={"/portalpages/attendance"} lable={"Attendance"}  />
